...
function CreateJupiter()
{
    var planet = new PlanetPS (
        "Jupiter", 
        100.4542, 2.76854e-5, 1.3030, -1.557e-7, 273.8777, 1.64505e-5, 5.20256, 0.0, 0.048498, 4.469e-9, 19.895, 0.0830853001,  // orbital elements
...
function CreateUranus()
{
    var planet = new PlanetPS (
        "Uranus", 
        74.0005, 1.3978e-5, 0.7733, 1.9e-8, 96.6612, 3.0565e-5, 19.18171, -1.55e-8, 0.047318, 7.45e-9, 142.5905, 0.011725806,   // orbital elements
...
function AstronomyClass()
{
    ...
    */
    ...
    this.Ceres   = CreateAsteroid ("Ceres",   2455200.5,  80.39385218745325, 10.58625542718085,   72.69269240394317, 2.76572318733308,  0.079221937086145,    70.43400313899033, 1680.008554020659, 3.34 + 1.11);   // http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=1
    this.Pallas  = CreateAsteroid ("Pallas",  2455200.5, 173.1284320041861,  34.84035770712999,  310.2064759380006,  2.772748784781192, 0.2309703296970875,   53.39542175895123, 1686.414052053065, 4.13 + 1.10);   // http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=2
    this.Juno    = CreateAsteroid ("Juno",    2455200.5, 169.9115485857683,  12.98205677828023,  248.0857793767332,  2.670000468072592, 0.2549658011711765,  346.9285138798231,  1593.549040340363, 5.33 + 0.92);   // http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=3
    this.Vesta   = CreateAsteroid ("Vesta",   2455200.5, 103.9148645013264,   7.134420968509158, 149.8368094343074,  2.361937325265019, 0.08872920479890047, 253.5042125123777,  1325.870112095862, 3.20 + 0.26);   // http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=4
