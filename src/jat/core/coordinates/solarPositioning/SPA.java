...
public class SPA {
	...
	public static AstroCoordinate getSolarPosition(final AstroDateTimeLocation adt, final double latitude,
		...
		ac.equatorialCoord = new EquatorialCoord(null, new Angle(alphaDegrees, Angle.DEGREES), new Angle(deltaDegrees,
				Angle.DEGREES));
		ac.horizontalCoord = new HorizontalCoord(new Angle(AzZe.getAzimuth(), Angle.DEGREES), new Angle(
				90 - AzZe.getZenithAngle(), Angle.DEGREES));
		return ac;
	 ...
	 */
	public static AzimuthZenithAngle calculateSolarPosition(final AstroDateTimeLocation adt, final double latitude,
			final double longitude, final double elevation, final double deltaT, final double pressure,
			final double temperature) {
	...
	private static AzimuthZenithAngle calculateTopocentricSolarPosition(final double p, final double t,
			final double phi, final double deltaPrime, final double hPrime) {
	...
	private static double calculateApparentSiderealTimeAtGreenwich(final JulianDateJoda jd, final double deltaPsi,
