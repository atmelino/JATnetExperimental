...
public class PractAstrTest14 {
	...
	public void run() {
		...
		AstroDateTimeLocation adtGreenwich = new AstroDateTimeLocation(1980, 4, 22, 14, 36, 51, 670, "UTC", longitudeGreenwich);
		Angle longitude64 = new Angle(-64., Angle.DEGREES);
		AstroDateTimeLocation adt64 = new AstroDateTimeLocation(1980, 4, 22, 14, 36, 51, 670, "UTC", longitude64);
	...
	public static void main(final String[] args) {
		...
		PractAstrTest14 p=new PractAstrTest14();
		p.run();
	}
