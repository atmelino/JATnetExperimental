...
public class PractAstrTest04 {
	...
	public void run() {
		...
		JD_HST = (new AstroDateTimeLocation(1985, 2, 17, 6, 0, 0, "HST")).getJD();
		JD_MST = (new AstroDateTimeLocation(1985, 2, 17, 6, 0, 0, "MST")).getJD();
		JD_CST = (new AstroDateTimeLocation(1985, 2, 17, 6, 0, 0, "CST6CDT")).getJD();
		JD_EST = (new AstroDateTimeLocation(1985, 2, 17, 6, 0, 0, "EST")).getJD();
		JD_UTC = (new AstroDateTimeLocation(1985, 2, 17, 6, 0, 0, "UTC")).getJD();
	...
	public static void main(final String[] args) {
		...
		PractAstrTest04 p=new PractAstrTest04();
		p.run();
	}
}
